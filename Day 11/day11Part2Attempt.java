...
/**
 * This class is my first attempt at a solution for Day 11 Part 2 that didn't work
 * 
 * Instance variables:
 ...
 */
public class day11Part2Attempt {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        ArrayList<day11Part2Attempt> monkeys = new ArrayList<day11Part2Attempt>();
        while(true) {
            input.nextLine();
            monkeys.add(new day11Part2Attempt(input.nextLine(), input.nextLine(),
     ...
     */
    public day11Part2Attempt(String startingItems, String operation, String test,
